...
public class TilesBut extends TilesButton
{
    public TilesBut(final Texture texture, final float x, final float y, final float w, final float h, final float[] color, final float rotation, final boolean clicked, final boolean hover, final String textureName) {
    ...
    protected void update() {
        if (this.isClicked()) {
            Update.texture = this.textureName;
            Update.tileTexture = this.texture;
        }
    }
    ...
    protected void render() {
        ...
        if (Update.texture.equals(this.textureName)) {
            TextureLoader.defaults.bind();
            GL11.glBegin(1);
